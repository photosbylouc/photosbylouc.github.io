...
$(document).ready(function(e){
	"true"!==sessionStorage.getItem("advertOnce")?(e(".splash").show(),window.setTimeout(function(){e(".splash h1").css("opacity","1")},1e3),window.setTimeout(function(){e(".splash p").css("opacity","1")},2e3),window.setTimeout(function(){e(".splash").fadeOut(800)},4e3),sessionStorage.setItem("advertOnce","true")):e(".splash").hide()
});
...
$(document).ready(function(){
    ...
    $(".menu-secondary .menu-item > a").click(function(e) {
      $(".sub-menu").removeClass('open'), $(this).next().hasClass('open') || $(this).next().addClass('open'),
      e.stopPropagation();
    });
    ...
    $(".menu-secondary #access .menu-item").hover(function() {
        $(this).addClass("show");
    }, function() {
