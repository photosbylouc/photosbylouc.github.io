...
!(function (t, e, n, o) {
  ...
  if (((t.console = t.console || { info: function (t) {} }), n)) {
    ...
    var i = {
        ...
        baseClass: "",
        baseTpl:
          '<div class="fancybox-container" role="dialog" tabindex="-1"><div class="fancybox-bg"></div><div class="fancybox-inner"><div class="fancybox-toolbar">{{buttons}}</div><div class="fancybox-stage"></div><div class="fancy-bottom"><div class="fancybox-navigation">{{arrows}}</div><div class="fancybox-infobar"><span data-fancybox-index class="first-num"></span>&nbsp;/&nbsp;<span data-fancybox-count></span></div></div></div></div>',
        ...
        btnTpl: {
          ...
          close:
            '<button data-fancybox-close class="fancybox-button fancybox-button--close fancy-close" title="{{CLOSE}}"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M12 10.6L6.6 5.2 5.2 6.6l5.4 5.4-5.4 5.4 1.4 1.4 5.4-5.4 5.4 5.4 1.4-1.4-5.4-5.4 5.4-5.4-1.4-1.4-5.4 5.4z"/></svg></button>',
          arrowLeft:
    ...
    n.extend(b.prototype, {
      ...
      setImage: function (t) {
        ...
        setTimeout(function () {
          ...
          a.checkSrcset(t),
          (t.$content = n(
            '<div class="fancybox-content fancy-close"><button data-fancybox-prev class="fancybox-nav-left"></button><button data-fancybox-next class="fancybox-nav-right"></button></div>'
          )
